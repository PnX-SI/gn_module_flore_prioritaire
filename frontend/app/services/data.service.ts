...
export class DataService {
  ...
  postZp(data: any) {
    return this._http.post<any>(`${AppConfig.API_ENDPOINT}/${ModuleConfig.MODULE_URL}/form_zp`, data);
  }

  patchZp(data: any, idZp) {
    return this._http.post<any>(`${AppConfig.API_ENDPOINT}/${ModuleConfig.MODULE_URL}/form_zp/${idZp}`, data);
  }

  postAp(data: any) {
    return this._http.post<any>(`${AppConfig.API_ENDPOINT}/${ModuleConfig.MODULE_URL}/form_ap`, data);
  }

  patchAp(data: any, idAp) {
    return this._http.post<any>(`${AppConfig.API_ENDPOINT}/${ModuleConfig.MODULE_URL}/form_ap/${idAp}`, data);
  }
