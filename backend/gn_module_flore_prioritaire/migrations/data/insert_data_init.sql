...
INSERT INTO pr_priority_flora.t_zprospect(indexzp, date_min, date_max, topo_valid, initial_insert, srid_design, cd_nom, geom_local, geom_4326, geom_point_4326)
...
INSERT INTO pr_priority_flora.cor_zp_obs(indexzp,codeobs)
...
INSERT INTO pr_priority_flora.t_apresence(indexap, area, frequency, topo_valid, altitude_min, altitude_max, nb_transects_frequency, nb_points_frequency, nb_contacts_frequency, nb_plots_count, area_plots_count, comment, step_length, indexzp, 
